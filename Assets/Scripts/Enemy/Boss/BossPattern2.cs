...
public class BossPattern2 : MonoBehaviour
{
    ...
    public GameObject Boss_Stage_2_Cruise_Missile;
    ...
    IEnumerator Pattern2() {
        ...
        for(int i = 0; i<8; i++) {
            Instantiate(Boss_Stage_2_Torpedo, Boss_FirePos.transform.position, Boss_FirePos.transform.rotation);
        ...
        yield return new WaitForSeconds(3.0f);
        Debug.Log("왜안돼?");
        Instantiate(Boss_Stage_2_Cruise_Missile, Boss_MissilePos.transform.position, Boss_MissilePos.transform.rotation);
